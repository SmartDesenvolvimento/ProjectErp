            ...
            <div class="box">
				...
				<div class="box-body" style ="max-width: 100%; overflow: scroll">
                    <table id="tableUsuario" class="table table-striped table-bordered">
					    ...
					    <tr>
							<td><?php echo $listUsuario->idUSUARIO?> </td>
                            <td><?php echo $listUsuario->CODIGO_USUARIO?> </td>
                            <td name="name"><?php echo $listUsuario->NOME?> </td>
                            <td><?php echo $listUsuario->RG?> </td>
							<td><?php echo $listUsuario->CPF?> </td>
                            <td><?php echo $listUsuario->ESTADO_NOME?> </td>
                            <td><?php echo $listUsuario->CIDADE_NOME?> </td>
                            <td><?php echo $listUsuario->ENDERECO?> </td>
                            <td><?php echo $listUsuario->FUNCAO?> </td>
                            <td><?php echo $listUsuario->TELEFONE?> </td>
							<td><?php echo $listUsuario->EMAIL?> </td>
							<td><?php echo $listUsuario->DATANASC_FORMAT?></td>
                            <td><?php echo $listUsuario->DATA_INCLUSAO?></td>
							<td><button id="alterar" type="button" class="btn btn-warning btn-sm" data-toggle="modal"
							data-target="#exampleModal" 
							data-id="<?php echo $listUsuario->idUSUARIO?>"
							data-codigousuario="<?php echo $listUsuario->CODIGO_USUARIO?>"
							...
							<td>
								<button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
									data-target="#excluirModal" data-idusuario="<?php echo $listUsuario->idUSUARIO?>"
									data-nome="<?php echo $listUsuario->NOME?>"
								>Excluir
								</button>
							</td>
      ...
      <div class="modal-body">
        ...
        <form role="form" action="controller/cUsuarioEdit.php" 
			method="post" enctype="multipart/form-data" name="frmCliente" onsubmit="return validar_senha(this);">
          	...
          	<div class="form-group">
          	  <label for="codigo_usuario" class="col-form-label">Código Usuário:</label>
			...
			<div class="form-group">
				<label>CPF</label> <input type="text" class="form-control"
					...
					value="" onKeyPress="MascaraCPF(frmCliente.cpf);" maxlength="14"
					>
			</div>
			<div class="form-group">
