		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="?menu=home">Produto</a></li>
					...
					<div class="col-xs-12">
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php $sql = "SELECT * FROM PRODUTO WHERE ATIVO = 1" ;
									...
									<tr>
										...
										<td><?php echo $prod['LOTE_MINIMO']?> </td>
										...
										<td><?php echo $prod['DATA_INCLUSAO']?> </td>
											<td style='width: 30px'>
												...
												echo
													'<a style="width: 50px"
													class="btn btn-warning btn-xs" href="?menu=produto_editar&id='
													. $prod['CODIGO_PRODUTO'].
													 '">Editar </a>';
												?>
											</td>
