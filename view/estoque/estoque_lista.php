		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Estoque Atual</li>
				</ol>
			</section>
							...
							<table id="example1" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th>Quantidade</th>
										<th>Validade</th>
										<th>Código Rastreabilidade</th>
										<th>Data Ultima Mov.</th>
									</tr>
								</thead>
								<tbody>
								<?php $sql = "SELECT 
									...
									<tr>
										...
										<td><?php echo $prod['CODIGO_RASTREABILIDADE']?> </td>
										<td><?php echo $prod['DATA_ULTIMA_MOV']?> </td>
									</tr>
								<?php 
								} ;
