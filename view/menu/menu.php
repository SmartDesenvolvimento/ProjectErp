<header class="main-header">
  ...
  ?>
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>S</b>G E</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Smart</b> Gestão ERP</span>
    </a>
	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src=<?php echo $imagemUsuario ?> class="img-circle"
					alt="User Image">
			</div>
		...
		<form action="#" method="get" class="sidebar-form">
			<div class="input-group">
				<input type="text" name="q" class="form-control"
					placeholder="Procurar..."> <span class="input-group-btn">
      ...
      -->
			<li class="treeview"><a href="#"> <i class="fa fa-users"></i> <span>Cliente</span>
					<span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="?menu=clientecadastro&acao=clientecadastro"><i class="fa fa-circle-o"></i>
							Cadastro</a></li>
					<li><a href="?menu=clientelistar&acao=clientelistar"><i class="fa fa-circle-o"></i>
							Clientes</a></li>
				</ul></li>
      <!--
      ...
      -->
			<li class="treeview"><a href="#"> <i class="fa  fa-user-plus"></i> <span>Usuário</span>
					<span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="?menu=usuario_cadastro"><i class="fa fa-circle-o"></i>
							Cadastro</a></li>
					<li><a href="?menu=usuario_lista&acao=usuario_listar"><i class="fa fa-circle-o"></i>
							Usuários</a></li>
				</ul></li>

        <li class="treeview"><a href="#"> <i class="fa fa-file-text"></i> <span>Termo Compromisso</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="?menu=termoCompromisso"><i class="fa fa-circle-o"></i>
							Termo de Compromisso</a></li>
				</ul></li>
		</ul>
	</section>
	<!-- /.sidebar -->
