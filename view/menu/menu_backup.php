	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="../../dist/img/taina.jpg" class="img-circle"
					alt="User Image">
			</div>
			<div class="pull-left info">
				<p>Vitor de Camargo</p>
		...
		<li class="treeview"><a href="#"> <i class="fa fa-cubes"></i> <span>Estoque</span>
			...
			<li class="treeview"><a href="#"> <i class="fa fa-users"></i> <span>Cliente</span>
				...
				<ul class="treeview-menu">
					<li><a href="?menu=cliente&acao=clientelistar"><i class="fa fa-circle-o"></i>
							Clientes</a></li>
					<li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i>
							Morris</a></li>
					<li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i>
			...
			<li class="treeview"><a href="#"> <i class="fa  fa-user-plus"></i> <span>Funcionario</span>
					<span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="?menu=funcionariolista&acao=funcionariolista"><i class="fa fa-circle-o"></i>
							Funcionarios</a></li>
					<li><a href="?menu=funcionario&acao=funcionariocadastrar"><i class="fa fa-circle-o"></i>
							Cadastrar Funcionario</a></li>
