				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box-header">
							<h3 class="box-title">Novo Recebimento</h3>
						</div>

						<!-- /.box-header -->
						<div class="box-body">
							<form role="form" action="../../model/recebimento/recebimento_cadastro.php" method="post" >
									
									<div class="form-group">
									<?php $query = mysqli_query($conexao,"SELECT CODIGO_FORNECEDOR, NOME FROM FORNECEDOR WHERE HABILITADO = 1 ORDER BY NOME");?>
										<label>Fornecedor</label> <select class="form-control" id="fornecedor" name="fornecedor">
											<option>Selecione...</option>
											<?php while($result = mysqli_fetch_array($query)) { ?>
 												<option value="<?php echo $result['CODIGO_FORNECEDOR'] ?>">
												 <?php echo $result['NOME'] ?></option>
												 <?php } ?>
										</select>
									</div>
									<div class="form-group">
										<label>Nota Fiscal</label> <input type="text" class="form-control"
											placeholder="N° NF ..." id="nf" name="nf" value="">
									</div>
									<br>
									<div class="col-md-12">
