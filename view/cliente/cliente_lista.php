				...
				<div class="box-body" style ="max-width: 100%; overflow: scroll">
                    <table id="tableCliente" class="table table-striped table-bordered">
					    ...
					    <tr>
                            ...
                            <td><?php echo $listCliente->NOME?> </td>
                            <td><?php echo $listCliente->TIPO_PESSOA?> </td>
                            <td><?php echo $listCliente->RG_CNPJ?> </td>
                            <td><?php echo $listCliente->CPF_IE?> </td>
                            <td><?php echo $listCliente->NOME_ESTADO?> </td>
                            <td><?php echo $listCliente->NOME_CIDADE?> </td>
                            ...
                            <td><?php echo $listCliente->DATA_NASCIMENTO_FORMAT?> </td>
                            <td><?php echo $listCliente->DATA_INCLUSAO_FORMAT?> </td>

                            <td>
                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
							    data-target="#exampleModal" 
							    data-codigo="<?php echo $listCliente->CODIGO?>"
							    data-nome="<?php echo $listCliente->NOME?>"
							    data-tipopessoa="<?php echo $listCliente->TIPO_PESSOA?>"
        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
			    ...
			    method="post" enctype="multipart/form-data" name="frmCliente" onsubmit="return validar_senha(this);">
                    ...
                    <div class="form-group">
                        <label>Tipo Pessoa</label> <select class="form-control" id="tipo_pessoa" name="tipo_pessoa" required name=tipo_pessoa>
                            <option></option>
...
<script type="text/javascript"> 
	$('#exampleModal').on('show.bs.modal', function (event) {
	  ...
	  modal.find('#tipo_pessoa').val(tipopessoa)
