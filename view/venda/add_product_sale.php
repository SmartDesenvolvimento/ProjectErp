			...
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div>
							<br>
							<form role="form" action="../../model/venda/venda_produto.php?id=<?php echo $id ?>" method="post" >
								<div class="row">
							...
							<br>
							<form role="form" action="../../model/venda/for_sale.php?id=<?php echo $id ?>" method="post" >
								<div class="row">
									<div class="col-md-4 form-group">
