					...
					<div class="col-xs-12">
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
								<?php $sql = "SELECT * FROM VENDA WHERE VENDA_FINALIZADA = 1" ;
									$query = mysqli_query($conexao,$sql) or die(mysql_error());
									while($prod = mysqli_fetch_array($query)) { ?>
									<tr>
										<td><?php echo $prod['idVENDA']?> </td>
										<td><?php echo $prod['CODIGO_CLIENTE']?> </td>
										<td><?php echo $prod['VENDEDOR']?> </td>
										<td><?php echo $prod['VALOR']?> </td>
										<td><?php echo $prod['DESCONTO']?> </td>
										<td><?php echo $prod['COMISSAO']?> </td>
										<td><?php echo $prod['DATA_VENDA']?> </td>
										<td><?php echo $prod['VISTA_PRAZO']?> </td>
									</tr>
								<?php 
								} ;
