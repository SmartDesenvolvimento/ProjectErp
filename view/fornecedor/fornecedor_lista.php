		...
		<div style="overflow-x:auto;height:100%; width:100%">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="?menu=home">Fornecedor</a></li>
					...
					<div class="col-xs-12">
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
								<?php $sql = "SELECT * FROM FORNECEDOR WHERE HABILITADO = 1" ;
									$query = mysqli_query($conexao,$sql) or die(mysql_error());
									while($prod = mysqli_fetch_array($query)) { ?>
									<tr>
										<td><?php echo $prod['CODIGO_FORNECEDOR']?> </td>
										<td><?php echo $prod['NOME']?> </td>
										<td><?php echo $prod['ESTADO']?> </td>
										<td><?php echo $prod['CIDADE']?> </td>
										<td><?php echo $prod['ENDERECO']?> </td>
										<td><?php echo $prod['CNPJ']?> </td>
										<td><?php echo $prod['INSCRICAO_ESTADUAL']?> </td>
										<td><?php echo $prod['TELEFONE']?> </td>
										<td><?php echo $prod['email']?> </td>
										<td><?php echo $prod['DATA_INCLUSAO']?> </td>
										<td><?php echo $prod['HABILITADO']?> </td>
											<td style='width: 300px'>
												<?php
												echo
													'<a style="width: 50px"
													class="btn btn-warning btn-xs" href="?menu=fornecedor_editar&id='
											...
											<td style='width: 300px'>
												...
												echo
													...
													class="btn btn-danger btn-xs" 
														href="../../model/fornecedor/fornecedor_excluir.php?id='
													. $prod['CODIGO_FORNECEDOR'].
													 '">Excluir </a>';
												?>
											</td>
