...
<link rel="stylesheet"
  ...
  <script language="JavaScript" type="text/javascript" src="bootstrap/js/MascaraValidacao.js"></script>
  ...
  <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    ...
    <?php
      if (isset($_GET['acao']))
      {
        ...
        if ($acao == 'clientelistar' || $acao = 'usuario_listar'){
