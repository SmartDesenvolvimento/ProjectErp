    ...
    if ( isset( $_FILES[ 'arquivo' ][ 'name' ] ) && $_FILES[ 'arquivo' ][ 'error' ] == 0 ) {
        ...
        if ( strstr ( '.jpg;.jpeg;.gif;.png', $extensao ) ) {
            ...
            if ( @move_uploaded_file ( $arquivo_tmp, $destino ) ) {
                ...
                $senha = sha1($senha).strlen($codUsuario);
                ...
                if ($Usuario->InsertUsuario()){
                    header('Location: ../home.php?menu=usuario_cadastro&sucesso=true&usuario='.$nome);
                }
                else{
                    header('Location: ../home.php?menu=usuario_cadastro&sucesso=false&usuario='.$nome);
                }
            }
            else{
                $Message->Alert('Erro ao salvar o arquivo. Aparentemente você não tem permissão de escrita!');

                header('Location: ../home.php?menu=usuario_cadastro');
            }
